...
class PortofolioController extends \BaseController {
	...
	public function create()
	{
	    ...
	    $path = public_path() . '/file/portofolio'; // upload directory
	    $fileName = NULL;

	    if ( $_SERVER['REQUEST_METHOD'] === 'POST' ){

	    	$file = Input::file('img_portofolio');
		...
		$portofolio->images 		= $fileName;

		 
		$portofolio->description 	= Input::get('description');
		$portofolio->save();

		return Redirect::to('dashboard/portofolio')->with('sukses', 'Data User Sudah Tersimpan');
	}
