                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class=" form">
                                  <form class="cmxform form-horizontal tasi-form" enctype="multipart/form-data" id="commentForm" method="POST" action="{{url('dashboard/portofolio/save')}}">
                                      ...
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">Image Portofolio</label>
                                          <div class="col-lg-10">
                                            <input type="file" name="img_portofolio" required />
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                          	<textarea class="form-control" id="textarea" name="description" required>Content Portofolio Here</textarea>
                                     	  </div>
                                      </div>
