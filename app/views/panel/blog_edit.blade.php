                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class=" form">
                                  {{ Form::open(array('action'=> 'BlogController@update','class'=>'cmxform form-horizontal tasi-form','enctype'=>'multipart/form-data')) }}
                                  {{ Form::open(['url' => 'BlogController@update', 'files' => true, 'method' => 'post']) }}
                                      ...
                                      <div class="form-group ">
                                       ...
                                       <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                            ...
                                            <br />
                                            <p> * Kosongkan Bila Tidak Di Ganti </p>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          <label for="cemail" class="control-label col-lg-2">Image Header Blog</label>
                                          <div class="col-lg-10">
                                            <img width="200px"src="{{asset('../file/blog/')}}/{{$blog->img_header}}">
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group ">
                                          ...
                                          <div class="col-lg-10">
                                          	<textarea class="form-control" id="editor1" name="content" required>{{$blog->content}}</textarea>
                                     	  </div>
                                      </div>
